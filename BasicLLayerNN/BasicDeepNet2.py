...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L):
        #print ("Performing loop: " + str(l))
        A_prev = A 
        #print ("Shape of A is " + str(A.shape))
        #print ("A below:")
        #print (A)
        #print ("Shape of W is " + str(parameters["W" + str(l)].shape))
        #print ("W below:")
        #print ( parameters["W" + str(l)])
        #print ("Shape of b is " + str(parameters["b" + str(l)].shape))
        #print ("b below:")
